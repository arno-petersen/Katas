...
namespace GameOfLifeConsole
{
    public class Options
    {
        ...
        [Option('s', "seed", Required = false, Default = 0, HelpText = "The pattern which initializes the grid. \r\n"+
                                                                       " 0 = Blinker \r\n" +
                                                                       " 1 = Toad \r\n" +
                                                                       " 2 = Beacon \r\n" +
                                                                       " 3 = Glider \r\n" +
        ...
        [Option('t', "ticks", Required = false, Default = -1, HelpText = "The maximum number of generations until the program ends. The default is set to infinite")]
